		...
		<div style="width: 1200px; margin: 0 auto; background: lime;">
			...
			<div style="margin-top: 50px; float: left;">
				<div style="width: 600px; height: 700px; float: left;">
					<div style="margin-top: 50px; font-size: 22px; font-weight: bold; text-align: center;">머무르다 소개</div>
				...
				<div><img style="width: 1200px; height: 60px; margin-top: 20px;" src="../resource/images/introduce_three.png"></div>
			</div>
			
			<div style="text-align: center; margin-top: 20px;"><button type="button" style="height: 50px;">문의하기</button></div>
		</div>
	</div>
</div>